            ...
            <div class="col-md-6 offset-md-3">
                ...
                <form action="/add" class="form" method="post">
                    ...
                    <div class="form-group row">
                        <label for="std_id" class="col-3 col-form-label">Student Id</label>
                        <div class="col-9">
                            <input type="text" class="form-control" name="std_id" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="std_name" class="col-3 col-form-label">Name</label>
                        <div class="col-9">
                            <input type="text" class="form-control" name="std_name" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="std_tel" class="col-3 col-form-label">Tel</label>
                        <div class="col-9">
